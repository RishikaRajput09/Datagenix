...
const BLOGS = [
  ...
  },
  {
    ...
    tag: "IoT",
    title:
      "IoT-Powered Smart Waste Management: What Municipal Corporations Need to Know",
    excerpt:
  ...
  },
  {
    ...
    tag: "AI & Tech",
    title:
      "Responsible AI and the SDGs: Building Technology That Serves Society",
    excerpt:
  ...
  },
  {
    ...
    tag: "AI & Tech",
    title:
      "AIRIAA: How We Built an AI-Powered Admission Assistant for College Campuses",
    excerpt:
  ...
  },
  {
    ...
    tag: "Industry",
    title:
      "From Data to Intelligence: Why Most Businesses Are Still Missing the Bridge",
    excerpt:
  ...
  },
  {
    ...
    tag: "Education",
    title:
      "AI Education and Skill India: Bridging the Gap Between Policy and Practice",
    excerpt:
  ...
  },
  {
    ...
    tag: "Smart Cities",
    title:
      "AI-Driven Environmental Monitoring: Tackling Pollution with Intelligent Sensors",
    excerpt:
  ...
  },
  {
    ...
    tag: "Education",
    title:
      "The Future Belongs to AI-Skilled Professionals: A Roadmap for 2025 and Beyond",
    excerpt:
...
const TAG_COLORS = {
  "AI & Tech": {
    bg: "rgba(33,198,207,0.1)",
    text: "#21C6CF",
    border: "rgba(33,198,207,0.2)",
  },
  IoT: {
...
function FeaturedCard({ blog }) {
  ...
  return (
    <div ref={r.ref} style={r.style}>
      <Link
        href={`/blog/${blog.slug}`}
        className="group block relative rounded-2xl border border-[rgba(33,198,207,0.15)] bg-[#0a0a0a] overflow-hidden hover:border-[rgba(33,198,207,0.3)] transition-all duration-300"
      >
        {/* Top shimmer */}
        ...
        <div className="flex flex-col lg:flex-row">
          ...
          <div className="lg:w-[48%] min-h-[240px] sm:min-h-[280px] bg-[#0d0d0d] relative overflow-hidden flex items-center justify-center border-b lg:border-b-0 lg:border-r border-[rgba(33,198,207,0.08)]">
            <div
              ...
              style={{
                background:
                  "radial-gradient(ellipse at center,rgba(33,198,207,0.06) 0%,transparent 70%)",
              }}
            />
            <div className="relative z-10 flex flex-col items-center gap-3">
              ...
              <span
                className="text-[rgba(33,198,207,0.3)] text-[0.6rem] tracking-[0.2em] uppercase"
            ...
            <div className="absolute top-4 left-4 inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-[rgba(33,198,207,0.12)] border border-[rgba(33,198,207,0.25)]">
              <span
                className="w-1.5 h-1.5 rounded-full bg-[#21C6CF] inline-block"
                style={{ boxShadow: "0 0 6px #21C6CF" }}
              />
              <span
                className="text-[#21C6CF] text-[0.58rem] tracking-widest uppercase font-medium"
                style={{ fontFamily: "'DM Sans',sans-serif" }}
              >
                Featured
              </span>
          ...
          <div className="flex-1 p-7 sm:p-9 flex flex-col justify-between">
            <div>
              <div className="flex items-center gap-2.5 mb-5">
                ...
                <span
                  className="text-[rgba(255,255,255,0.2)] text-[0.65rem]"
                  style={{ fontFamily: "'DM Sans',sans-serif" }}
                >
              ...
              <h2
                className="text-white font-bold text-[1.3rem] sm:text-[1.6rem] leading-[1.3] tracking-[-0.02em] mb-4 group-hover:text-[#21C6CF] transition-colors duration-300"
                style={{ fontFamily: "'Syne',sans-serif" }}
              >
                {blog.title}
              </h2>
              <p
                className="text-[rgba(255,255,255,0.4)] text-[0.85rem] leading-[1.8]"
            ...
            <div
              className="flex items-center gap-2 mt-7 text-[#21C6CF] text-[0.78rem] font-semibold tracking-wide"
              style={{ fontFamily: "'DM Sans',sans-serif" }}
            >
              Read Article
              <svg
...
function BlogCard({ blog, delay = 0 }) {
  ...
  return (
    <div ref={r.ref} style={r.style} className="h-full">
      <Link
        href={`/blog/${blog.slug}`}
        className="group h-full flex flex-col rounded-xl border border-[rgba(33,198,207,0.08)] bg-[#0a0a0a] overflow-hidden hover:border-[rgba(33,198,207,0.25)] transition-all duration-300 relative"
      >
        {/* Top shimmer */}
        ...
        <div className="h-[160px] bg-[#0d0d0d] relative overflow-hidden flex items-center justify-center flex-shrink-0">
          <div
            ...
            style={{
              background:
                "radial-gradient(ellipse at center,rgba(33,198,207,0.04) 0%,transparent 70%)",
            }}
          />
        ...
        <div className="flex flex-col flex-1 p-5">
          ...
          <h3
            className="text-white font-bold text-[0.92rem] sm:text-[0.98rem] leading-[1.45] tracking-[-0.01em] mb-3 group-hover:text-[#21C6CF] transition-colors duration-300 flex-1"
            style={{ fontFamily: "'Syne',sans-serif" }}
          >
            {blog.title}
          </h3>
          <p
            className="text-[rgba(255,255,255,0.35)] text-[0.77rem] leading-[1.7] mb-4 line-clamp-2"
            style={{ fontFamily: "'DM Sans',sans-serif", fontWeight: 300 }}
          >
            {blog.excerpt}
          </p>
          ...
          <div className="flex items-center justify-between pt-4 border-t border-[rgba(33,198,207,0.07)] mt-auto">
            <span
              className="text-[rgba(255,255,255,0.22)] text-[0.68rem]"
              style={{ fontFamily: "'DM Sans',sans-serif" }}
            >
              {blog.date}
            </span>
            <div
              className="flex items-center gap-1.5 text-[rgba(33,198,207,0.6)] text-[0.68rem]"
              style={{ fontFamily: "'DM Sans',sans-serif" }}
            >
              {blog.readTime}
              <svg
  ...
  return (
    <section className="bg-none relative overflow-hidden pt-26 pb-12">
      ...
      <div className="relative z-10 max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-10 text-center">
        ...
        <div style={fade(160)}>
          <h1
            className="text-[2.2rem] sm:text-[3rem] lg:text-[3.8rem] font-bold text-white leading-[1.1] tracking-[-0.03em] mb-5"
            style={{ fontFamily: "'Syne',sans-serif" }}
          >
            The DatagenixAi <span className="text-[#28E7C5]">Blog</span>
          </h1>
        </div>
        <div style={fade(240)}>
          <p
            className="text-[rgba(255,255,255,0.38)] text-[0.9rem] sm:text-[1rem] leading-[1.8] max-w-[520px] mx-auto"
            style={{ fontFamily: "'DM Sans',sans-serif", fontWeight: 300 }}
          >
            Ideas, insights, and innovation from the intersection of AI, IoT,
            industry, and education. Written by practitioners, for
            practitioners.
          </p>
        </div>
      </div>
...
export default function BlogPage() {
  ...
  const filtered =
    activeCategory === "All"
      ? rest
      : rest.filter(
          (b) => b.tag === activeCategory || b.category === activeCategory,
        );
    ...
    <main className="bg-linear-to-r from-[#140c30] via-[#153D4C] to-[#16A085] min-h-screen">
      ...
      <div className="relative bg-none">
        <div className="relative z-10 max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-10">
          ...
          >
            <span
              className="text-[rgba(255,255,255,0.2)] text-[0.68rem] tracking-widest uppercase mr-1 shrink-0"
              style={{ fontFamily: "'DM Sans',sans-serif" }}
            >
              Filter:
            </span>
            ...
            {/* Post count */}
            <span
              className="ml-auto text-[rgba(255,255,255,0.18)] text-[0.68rem]"
              style={{ fontFamily: "'DM Sans',sans-serif" }}
            >
          ...
          {visible.length === 0 && (
            <div className="flex flex-col items-center justify-center py-20 gap-4">
              ...
              <p
                className="text-[rgba(255,255,255,0.3)] text-[0.85rem]"
                style={{ fontFamily: "'DM Sans',sans-serif" }}
              >
              ...
              <button
                ...
                className="text-[#21C6CF] text-[0.78rem] underline underline-offset-4"
                style={{ fontFamily: "'DM Sans',sans-serif" }}
              >
                View all articles
              </button>
          ...
          {!showAll && filtered.length > 5 && (
            <div
              ref={loadMoreRef}
              className="flex flex-col items-center gap-4 mt-14 pb-12"
            >
              {/* Progress indicator */}
              <div className="flex items-center gap-3 mb-1">
                <div className="h-px w-20 bg-gradient-to-r from-transparent to-[rgba(33,198,207,0.3)]" />
                <span
                  className="text-[rgba(255,255,255,0.2)] text-[0.68rem] tracking-widest"
                  style={{ fontFamily: "'DM Sans',sans-serif" }}
                >
              ...
              >
                ...
                {loading ? (
                  <>
                    <svg
                      className="w-4 h-4 animate-spin relative z-[1] text-[#21C6CF]"
                      viewBox="0 0 24 24"
                      fill="none"
                    >
                      <circle
                  ...
                  <>
                    ...
                    <svg
                      className="relative z-[1] w-3.5 h-3.5 transition-transform duration-300 group-hover:translate-y-0.5"
                      viewBox="0 0 14 14"
                      fill="none"
                    >
                      <path
