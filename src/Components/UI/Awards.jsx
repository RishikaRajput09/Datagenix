...
export default function AwardsSection() {
  ...
  return (
    ...
    >
      ...
      hover:shadow-[0_0_24px_rgba(33,198,207,0.45)]
      hover:scale-[1.03]
    "
          >
        ...
        <div className="flex flex-col justify-between w-full lg:w-[48%] px-6 sm:px-10 lg:px-16 pt-6 pb-10 lg:pb-12">
          ...
          >
            ...
            <div className="inline-flex items-center gap-1.5 mb-5">
              ...
              <span className="text-[0.58rem] sm:text-[0.63rem] font-medium tracking-[0.16em] uppercase text-[rgba(33,198,207,0.65)]">
                {award.tag}
              </span>
            </div>
          ...
          <div className="flex items-center gap-5 mt-8">
            ...
            <span className="text-[0.7rem] tracking-[0.12em] text-[rgba(255,255,255,0.2)] ml-1">
